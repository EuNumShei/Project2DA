...
void apresentacao_do_menu_inicial(){
    ...
    vector<string> vetor = {"               1. Extra fully connected graphs                   |",
                            "               2. Real world graphs                              |",
                            "               3. Toy graphs                                     |",
                            "               4. Terminar programa                              |"};
...
Rede inicializar_rede() {
    ...
    cin >> in;
    switch (in) {
        case 1: std::cout << "Write the number of edges do you want: (ex: 25, 50, 75, 100, 200, 300, 400, 500, 600, 700, 800, 900)" << std::endl;
            real_graphs = false;
            std::cin >> num;
            break;
        case 2:  std::cout << "Write 1,2 or 3 about the size of the graph" << std::endl;
            real_graphs = true;
            std::cin >> num;
            break;
        case 3: num = 1; //não sei se é suposto poder ser só nos toy graphs
                break;
        case 4: exit(0);
    }
//initialize time stamp
    ...
    Rede rede = Rede(num, real_graphs);
...
int main(){
    ...
    Rede rede = inicializar_rede();

    //rede.print_edges_stadiums();
    //rede.print_edges_shipping();
    //rede.print_edges_tourism();
    //rede.print_edges_graph();
    return 0;
}
